...
contract AaveV3Ethereum_LMUpdateSdfsdf_20241115 is LMUpdateBaseTest {
  address public constant override REWARD_ASSET = 0xC035a7cf15375cE2706766804551791aD035E0C2;
  uint256 public constant override NEW_TOTAL_DISTRIBUTION = 200 * 10 ** 18;
  address public constant override EMISSION_MANAGER = AaveV3Ethereum.EMISSION_MANAGER;
  uint256 public constant NEW_DURATION_DISTRIBUTION_END = 5 days;
  address public constant aWETH_WHALE = 0xA339d279E0A3a9EDe11ecEAC2ec9529EeBDAE12C;
  ...
  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 21194480);
