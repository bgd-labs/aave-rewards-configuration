...
contract AaveV3Ethereum_LMUpdateRenewUSDSLM_20241030 is LMUpdateBaseTest {
  address public constant override REWARD_ASSET = AaveV3EthereumAssets.USDS_A_TOKEN;
  uint256 public constant override NEW_TOTAL_DISTRIBUTION = 119953 * 10 ** 18;
  ...
  address public constant aUSDS_WHALE = 0x3c66133A7fD29ab1E551db9E8832DCA0cEAd7a16;

  address public constant override DEFAULT_INCENTIVES_CONTROLLER =
    AaveV3Ethereum.DEFAULT_INCENTIVES_CONTROLLER;

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 21077647);
  }
