...
contract AaveV3Ethereum_LMUpdateRenewUSDSLM8_20241202 is LMUpdateBaseTest {
  ...
  uint256 public constant override NEW_TOTAL_DISTRIBUTION = 210130.86 * 10 ** 18;
  ...
  address public constant aUSDS_WHALE = 0x961972a5c91E7237A3b02d2ee173ac3999e49480;

  address public constant override DEFAULT_INCENTIVES_CONTROLLER =
    AaveV3Ethereum.DEFAULT_INCENTIVES_CONTROLLER;

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 21315801);
  }
