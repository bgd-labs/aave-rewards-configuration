...
contract AaveV3Ethereum_LMUpdateRenewUSDSLM13_20250107 is LMUpdateBaseTest {
  address public constant override REWARD_ASSET = AaveV3EthereumAssets.USDS_A_TOKEN;
  uint256 public constant override NEW_TOTAL_DISTRIBUTION = 229731 * 10 ** 18;
  ...
  address public constant aUSDS_WHALE = 0xdD84Ce1aDcb3A4908Db61A1dFA3353C3974c5a2B;

  address public constant override DEFAULT_INCENTIVES_CONTROLLER =
    AaveV3Ethereum.DEFAULT_INCENTIVES_CONTROLLER;

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 21571566);
  }
