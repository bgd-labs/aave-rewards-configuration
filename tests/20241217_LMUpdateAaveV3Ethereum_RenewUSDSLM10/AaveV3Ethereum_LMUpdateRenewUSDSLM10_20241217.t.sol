...
contract AaveV3Ethereum_LMUpdateRenewUSDSLM10_20241217 is LMUpdateBaseTest {
  address public constant override REWARD_ASSET = AaveV3EthereumAssets.USDS_A_TOKEN;
  uint256 public constant override NEW_TOTAL_DISTRIBUTION = 178600 * 10 ** 18;
  ...
  address public constant aUSDS_WHALE = 0x832c30802054F60f0CeDb5BE1F9A0e3da2a0Cab4;

  address public constant override DEFAULT_INCENTIVES_CONTROLLER =
    AaveV3Ethereum.DEFAULT_INCENTIVES_CONTROLLER;

  function setUp() public {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 21421124);
  }
